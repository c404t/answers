//در نسخه‌ی آخر برنامه، نحوه‌ی رسیدگی به خطا را طوری تغییر دهید که با برخورد به اولین سطر حاوی خطا، خواندن اطلاعات دانشجویان متوقف شود و اجرای برنامه بعد از آن به طور عادی ادامه یابد
#include <iostream>
#include <string>
#include <vector>
#include <fstream>
